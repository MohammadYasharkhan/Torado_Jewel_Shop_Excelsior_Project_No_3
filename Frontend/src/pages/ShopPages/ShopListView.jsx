...
{
    return <>
        <BreadCrumbSection title={"Shop List View"} linkTitle={"Shop"}></BreadCrumbSection>
        <div className='container ptb-100'>
            <div className='row'>
                ...
                <div className='col-xl-9 col-lg-8'>
                    <FilterBox activeView='list-view'></FilterBox>
                    <ShopProductDisplay withLoadMoreBtn={false} activeView='list-view'></ShopProductDisplay>
