...
function ShopTwoColumn()
{
    return <>
        <BreadCrumbSection title={"Shop 2 Columns"} linkTitle={"Shop"}></BreadCrumbSection>
        <div className='container ptb-100'>
            <div className='row'>
                ...
                <div className='col-xl-9 col-lg-8'>
                    <FilterBox activeView='grid-2'></FilterBox>
                    <ShopProductDisplay withLoadMoreBtn={false} activeView='grid-2'></ShopProductDisplay>
