...
import { resetPasswordEmailTemplate } from "../templates/email/forgetPasswordTemplate.js";
...
class MailService {
    ...
    {
        try {
            const verifyUrl = `${process.env.FRONTEND_URL}/resetPassword/verify?token=${token}`;
            const transporter = nodemailer.createTransport({
                host: "smtp.gmail.com",
                port: 587,
                secure: false,
